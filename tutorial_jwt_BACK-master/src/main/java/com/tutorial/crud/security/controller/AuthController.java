...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtDto> login(@Valid @RequestBody LoginUsuario loginUsuario /*String bo*/, BindingResult bindingResult){
    	/*LoginUsuario loginUsuario = new LoginUsuario();
    	loginUsuario.setNombreUsuario("admin");
    	loginUsuario.setPassword("admin");
