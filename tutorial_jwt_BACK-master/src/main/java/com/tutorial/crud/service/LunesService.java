 ...
 * La interfaz de service tendría esta estructura LunesService.java:
...
//Interfaz en el que manda a llamar los métodos creados en LunesServiceImpl.java
import java.util.List;

import com.tutorial.crud.entity.Lunes;

public interface LunesService {
