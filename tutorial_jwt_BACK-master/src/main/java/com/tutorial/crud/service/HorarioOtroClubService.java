 ...
 * La interfaz de service tendría esta estructura HorarioOtroClubService.java:
...
//Interfaz en el que manda a llamar los métodos creados en HOrarioOtroClucServiceImpl.java
public interface HorarioOtroClubService {
