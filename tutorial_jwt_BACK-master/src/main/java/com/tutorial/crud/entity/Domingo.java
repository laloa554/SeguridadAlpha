...
@Table(name="domingo") //se utiliza para poner el nombre real de la tabla en la base de datos
public class Domingo {

	@Id //Define la llave primaria.
	@Column(name="iddomingo") //Permite establecer el nombre de la columna de la tabla con la que el atributo debe de mapear.
	private int idDomingo; 
	...
	public int getIdDomingo() {
		return idDomingo;
	}

	public void setIdDomingo(int idDomingo) {
