/*En nuestra clase PedidoDAOImpl, implementamos la interfaz, le añadiremos la anotación 
...
@Component("pedidoDAOImpl")//Es el estereotipo principal, indica que la clase anotada es un component.
...
public class PedidoDAOImpl implements PedidoDAO
{
	...
	@Autowired //Inyecta la dependencia del objeto implícitamente.
	//Método que inicia sesión y le asigna un query y a su vez se lo guarda a su lista, todo es de PEDIDO. 
	private EntityManager entityManager;

	//comprobar si estás sobrescribiendo correctamente un método.
	@Override 
	@Transactional
	public List<Pedido> findAll() 
	{
	     ...
	     List<Pedido> pedido = theQuery.getResultList();
	     return pedido;
	}
	...
	//Este último método guarda la informacion de PEDIDO
	@Override
    @Transactional
