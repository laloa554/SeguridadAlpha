/*En nuestra clase LunesDAOImpl, implementamos la interfaz, le añadiremos la anotación 
...
@Component("lunesDAOImpl")  //Es el estereotipo principal, indica que la clase anotada es un component.
@Repository //Es un marcador para cualquier clase que cumpla el rol o el estereotipo de un repositorio (DAO).
public class LunesDAOImpl implements LunesDAO {
	...
	public List<Lunes> findAll() {
		 Session currentSession = entityManager.unwrap(Session.class);
	        ...
	        Query<Lunes> theQuery = currentSession.createQuery("from Lunes", Lunes.class);

	        List<Lunes> lunes = theQuery.getResultList();
	...
	public void save(Lunes lunes) {
        ...
        currentSession.saveOrUpdate(lunes);  
	}
	...
	public Lunes findById(int clave) {
        ...
        Lunes lunes = currentSession.get(Lunes.class, clave);
